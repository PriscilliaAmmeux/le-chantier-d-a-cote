      ...
      <div className="story-content-flex">
        <div className="story-content">
          <p className="text-left">
            ...
            construit autour d’une conviction : pour (re)trouver sa place dans
            la société, il faut d’abord être écouté, compris, puis accompagné.
          </p>
          <p className="text-left">
            <span className="font-bold">Le Chantier d’à Côté</span> s’inscrit
            dans l’économie sociale et solidaire en portant un chantier
            d’insertion, en lien avec des réseaux engagés tels que Chantier
            École, INAE, Convergence ou encore le GIE Green, dont nous sommes
            membres.
          </p>
          <p className="text-left">
          ...
          <p className="text-left">
            ...
            rapport distendu au travail. Deux années d’accompagnement ne
            suffisent parfois pas à une réinsertion durable.
          </p>
          <p className="text-left">
          ...
          <ul className="story-list">
            ...
            <li>
              Un appui partenarial, via une coordinatrice et 3 chargées de
              mission spécialisées dans les problématiques sociales majeures.
            </li>
          </ul>
        ...
        <div className="story-image-wrapper">
          <img
            src="/histoire.webp"
            alt="Histoire du chantier"
            className="story-image"
          />
          <img
            src="/raisin.webp"
            alt="illustration d'un raison"
            className="story-image"
          />
          <img
            src="/peintre.webp"
            alt="illustration d'un peintre du batiment"
            className="story-image"
          />
          <img
            src="/espace-verts.webp"
            alt="illustration d'espace verts"
            className="story-image"
          />
        </div>
      </div>
